...
import { Check, ChevronDown } from "lucide-react";const page = () => {
  ...
  <div className="flex flex-col bg-white min-h-screen">
      ...
      <div className="overflow-x-auto">
        <div className="w-full rounded-2xl bg-white border-gray-200 shadow-lg p-6">
          <table className="w-full border-collapse rounded-lg overflow-hidden">
            <thead>
              <tr className="bg-[#0A0A23] text-white">
                ...
                <th className="px-4 py-3 text-left text-sm font-medium">CNIC</th>
                <th className="px-4 py-3 text-left text-sm font-medium">DOB</th>
                <th className="px-4 py-3 text-left text-sm font-medium">Working Status</th>
            ...
            <tbody>
              {users.map((d, i) => (
                <tr key={i} className="text-black transition">
                  <td className="px-4 py-3 text-sm border border-blue-700">{d.id}</td>
                  <td className="px-4 py-3 text-sm border border-blue-700 font-medium">
                    {d.name}
                  </td>
                  <td className="px-4 py-3 text-sm border border-blue-700">{d.father}</td>
                  <td className="px-4 py-3 text-sm border border-blue-700">{d.cnic}</td>
                  <td className="px-4 py-3 text-sm border border-blue-700">{d.dob}</td>
